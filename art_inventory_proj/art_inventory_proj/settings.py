"""
Django settings for art_inventory_proj project.
...
SECRET_KEY = 'django-insecure-v3e$gxw2lu7n12y!%dag-xaeflmzlcdb%)lvezl=&%)=p%4_^l'
...
ROOT_URLCONF = 'art_inventory_proj.urls'
...
WSGI_APPLICATION = 'art_inventory_proj.wsgi.application'
